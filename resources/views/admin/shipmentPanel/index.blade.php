            ...
            <div class="modal-body">
                <form action="function.php" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="consignee" placeholder="Consignee" id="consignee"
                            aria-label="Consignee" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Item</span>
                        <input type="text" name="item" placeholder="Item" aria-label="Item" id="item"
                            class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Size of item</span>
                        <input type="text" name="size" placeholder="Size of item" id="size"
                            aria-label="Size of item" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">BL Number</span>
                        <input type="text" name="BL_number" placeholder="BL Number" id="BL_number"
                            aria-label="BL Number" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Shipping Line</span>
                        <input type="text" name="shipping_line" placeholder="Shipping Line" id="shipping_number"
                            aria-label="Shipping Line" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Arrival Time</span>
                        <input type="date" name="arrival_time" placeholder="Arrival Time" id="arrival"
                            aria-label="Arrival Time" class="form-control" required>
                    </div></br>
                    <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <fieldset disabled>
                    ...
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Name</span>
                        <input type="text" name="fname" id="fname1" placeholder="Given name"
                            aria-label="Given name" class="form-control" required>
                        <input type="text" name="mname" id="mname1" placeholder="Middle name"
                            aria-label="Middle name" class="form-control">
                        <input type="text" name="lname" id="lname1" placeholder="Surname"
                            aria-label="Surname" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">ID Number</span>
                        <input type="text" name="id_number" id="id_number1" placeholder="ID Number"
                            aria-label="ID Number" class="form-control" required>
                    </div></br>
                    <div class="input-group">
                        <span class="input-group-text"
                            style="background-color: #4EA646; font-weight: 600; color: white;">Contact Number</span>
                        <input type="text" name="contact" id="contact1" placeholder="Contact Number"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" id="username1" placeholder="Username"
                            aria-label="Username" class="form-control" required>
                    </div></br>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
