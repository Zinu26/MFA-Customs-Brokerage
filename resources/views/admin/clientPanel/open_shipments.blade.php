...
<div class="table">
    <div class="table-header">
        ...
        <div>
            ...
            <a
                href="@if (Auth::user()->type == 'admin') {{ route('close_shipment', $consignee->id) }}@elseif(Auth::user()->type == 'employee'){{ route('close_shipment.employee', $consignee->id) }} @endif">
                <button class="btn btn-danger"><i class="fas fa-folder-minus"></i><span class="sr-only"> CLOSE SHIPMENTS</span></button>
            </a>
        </div>
    </div>
</div>
